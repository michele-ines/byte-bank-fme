...
export default function HomePage() {
  return (
    <div
      className="w-full min-h-screen home-background"
    >

      <div className="max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 py-8">
        {/* Gráfico financeiro */}
        <section className="mt-16">
          <h2 className="vantagem-title mb-8 text-center text-[20px] md:text-[25px] text-[var(--byte-color-black)]">
            Análise Financeira
          </h2>
        </section>
        ...
        <section className="flex flex-col items-center gap-10 lg:flex-row lg:justify-between lg:gap-4">
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
            <img src={bannerIlustracao} alt="Banner ilustrativo" width={600} height={400} />
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 text-[var(--byte-color-green-500)]">
            ...
            <div className="flex flex-col items-center text-center p-4">
              <img
                ...
                className="mb-4"
              />
              <h3 className="vantagem-title mb-2 text-[20px]">
